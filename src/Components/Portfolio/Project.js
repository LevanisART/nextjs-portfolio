      ...
      <div>
                ...
                <div className="mt-3 mb-3 mb-md-0 py-1">
                  <a href={image} target="_blank" rel="noopener noreferrer" className="project_inner">
                    ...
                    <div className="projectimage"><img src={image} alt=""/></div>
                  </a>
                </div>
                  ...
                  <div className="content">
                    <div className="text">
                      {
                        date &&
                        <div className="info-item project-date w-100 mb-3 d-flex">
                      ...
                      { 
                        description &&
                        <div className="info-item description w-100 mb-3 d-flex">
                      ...
                      {
                        dribbble &&
                        <div className="info-item dribbble-shot w-100 mb-3 d-flex">
              ...
              { screenshots
                ...
                <div className="item d-flex flex-column">
                  <div className="d-flex align-items-center">
                    ...
                    <h5 className="title pl-4">Screenshots</h5>
                  </div>
				      		<div className="content">
